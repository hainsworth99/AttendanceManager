...
# secret key is saved in ~/.bash_rc as environment variable
SECRET_KEY = os.environ.get('ATTENDANCE_MANAGER_SECRET_KEY')
...
# using postgresql database on localhost
# database login info stored in environment variables 
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': os.environ.get('ATTENDANCE_MANAGER_DB_NAME'),
        'USER': os.environ.get('ATTENDANCE_MANAGER_DB_USER'),
        'PASSWORD': os.environ.get('ATTENDANCE_MANAGER_DB_PASSWORD'),
        'HOST': 'localhost',
        'PORT': '',
    }
}
...
AUTH_USER_MODEL = 'users.CustomUser'  # creating CustomUser for user model based on AbstractUser
...
EMAIL_HOST_PASSWORD = os.environ.get('ATTENDANCE_MANAGER_SENDGRID_PASSWORD')
EMAIL_PORT = 587
EMAIL_USE_TLS = True
